...
// API Coupon Routes --> TODO: Abtract to API controller later
router.post('/add-coupon', couponSchema, addCoupon)
router.post('/get-coupons', authorize(Role.Admin), getUserCoupons)
